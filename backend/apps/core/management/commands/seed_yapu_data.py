        ...
        programs = [
            {
                ...
                'category': 'sosial',
                'status': 'aktif',
                'description': 'Program tahunan pembagian paket sembako, takjil, dan santunan untuk keluarga pra-sejahtera dan dhuafa selama bulan suci Ramadan.',
                'content': '<p>Program Bakti Sosial Ramadan YAPU adalah inisiatif tahunan yang bertujuan untuk meringankan beban masyarakat kurang mampu. Setiap tahunnya, YAPU membagikan ribuan paket sembako dan makanan berbuka puasa di berbagai titik pelosok.</p>',
