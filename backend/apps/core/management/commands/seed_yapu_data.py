        ...
        programs = [
            {
                ...
                'category': 'sosial',
                'status': 'aktif',
                'description': 'Program bakti sosial menjelang dan selama bulan Ramadan, meliputi pembagian sembako, buka puasa bersama, dan santunan kepada masyarakat dhuafa di berbagai wilayah.',
                'content': '<p>Program Bakti Sosial Ramadan YAPU hadir setiap tahun untuk menjangkau masyarakat yang membutuhkan. Kegiatan meliputi pembagian paket sembako, buka puasa bersama anak yatim, dan santunan tunai kepada keluarga dhuafa.</p>',
            ...
            },
            {
                ...
                'category': 'sosial',
                'status': 'aktif',
                'description': 'Program rutin penyantuan anak yatim yang mencakup bantuan pendidikan, pemenuhan kebutuhan pokok, dan pembinaan karakter secara berkelanjutan.',
            ...
            },
            {
                ...
                'image': 'https://res.cloudinary.com/drturcggf/image/upload/v1775537364/DSC05826_xhe3nn.jpg',
                'is_featured': True,
            },
            {
            ...
            {
                'title': 'Gerakan Tanam 10.000 Pohon',
                'category': 'lingkungan',
                'status': 'aktif',
                'description': 'Gerakan penghijauan melalui penanaman 10.000 pohon di berbagai wilayah sebagai bentuk kepedulian YAPU terhadap kelestarian lingkungan hidup.',
                'content': '<p>Gerakan Tanam 10.000 Pohon adalah wujud nyata kepedulian YAPU terhadap lingkungan. Kegiatan ini melibatkan relawan, masyarakat lokal, dan pemerintah daerah dalam menanam pohon di lahan kritis dan area publik.</p>',
                'image': 'https://res.cloudinary.com/drturcggf/image/upload/v1775537340/IMG_1634_px9rdk.jpg',
                'is_featured': True,
            },
            {
                'title': 'Gerakan Pasar Murah',
                'category': 'sosial',
                'status': 'selesai',
                'description': 'Penyediaan kebutuhan pokok dengan harga terjangkau bagi masyarakat berpenghasilan rendah, khususnya menjelang hari raya dan saat harga kebutuhan pokok melonjak.',
            ...
            {
                'title': 'Pengajian Umum & Tabligh Akbar',
                'category': 'keagamaan',
                'status': 'aktif',
                'description': 'Kegiatan keagamaan berupa pengajian umum dan tabligh akbar menghadirkan ulama terkemuka untuk memperkuat ukhuwah islamiyah dan syiar Islam di tengah masyarakat.',
