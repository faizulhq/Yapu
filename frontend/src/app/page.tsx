        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-center">
            {(partnerList.length > 0 ? partnerList.map((p) => p.name) : [
              "Bank Mandiri", "BPDAS Pemali Jratun", "Pengurus NU Cilacap", "INSIMA Majenang",
              "Paguyuban Jawa Tengah", "Badan Pangan Nasional", "UPTD Puskesmas Majenang II", "Dinas LHK Jateng"
            ]).map((name) => (
